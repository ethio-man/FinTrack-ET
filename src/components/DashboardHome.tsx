...
import { Globe, Cloud, Bell, HelpCircle, Search, User, LogOut, Moon, Sun, RefreshCw, CheckCircle, AlertOctagon } from "lucide-react";
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button className="md:hidden w-10 h-10 rounded-full bg-[var(--bg-core)] border border-[var(--border-core)] flex items-center justify-center text-[var(--text-sec)] shadow-sm">
               <Search className="w-4 h-4" />
            </button>
